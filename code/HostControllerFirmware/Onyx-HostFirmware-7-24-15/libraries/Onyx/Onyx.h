...
class Onyx {
	private:
		int _attitude; //Needs to be further developed (similar to apeed, the robots attitude is a prototype hardware-control emotion) greateer attitude = greater speed
		int _mode;
        int _ServoList[12];
		int _rotation;
		int _height;
